...
public extension CodeEditor.Language {
    ...
    static var dust = CodeEditor.Language(rawValue: "dust")
    ...
    static var glsl = CodeEditor.Language(rawValue: "glsl")
    ...
    static var haml = CodeEditor.Language(rawValue: "haml")
    static var haskell = CodeEditor.Language(rawValue: "haskell")
    static var hsp = CodeEditor.Language(rawValue: "hsp")
    ...
    static var leaf = CodeEditor.Language(rawValue: "leaf")
    static var less = CodeEditor.Language(rawValue: "less")
    static var lisp = CodeEditor.Language(rawValue: "lisp")
    static var livescript = CodeEditor.Language(rawValue: "livescript")
    static var llvm = CodeEditor.Language(rawValue: "llvm")
    ...
    static var moonscript = CodeEditor.Language(rawValue: "moonscript")
    ...
    static var q = CodeEditor.Language(rawValue: "q")
    ...
    static var vbscriptHTML = CodeEditor.Language(rawValue: "vbscript-html")
    static var vhdl = CodeEditor.Language(rawValue: "vhdl")
    static var wasm = CodeEditor.Language(rawValue: "wasm")
    static var xl = CodeEditor.Language(rawValue: "xl")
    static var xml = CodeEditor.Language(rawValue: "xml")
    static var xquery = CodeEditor.Language(rawValue: "xquery")
